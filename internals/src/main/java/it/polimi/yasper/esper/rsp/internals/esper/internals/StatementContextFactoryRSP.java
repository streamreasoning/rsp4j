 ...
 */
public class StatementContextFactoryRSP implements StatementContextFactory {
     ...
     */
    public StatementContextFactoryRSP(PluggableObjectCollection viewPlugIns, PluggableObjectCollection plugInPatternObj, Class systemVirtualDWViewFactory) {
    ...
    public StatementContext makeContext(int statementId,
        ...
        StatementContextFactoryDefault.AnnotationAnalysisResult annotationData = StatementContextFactoryDefault.AnnotationAnalysisResult.analyzeAnnotations(annotations);
    ...
    public static class AnnotationAnalysisResult {
         ...
         */
        public static StatementContextFactoryRSP.AnnotationAnalysisResult analyzeAnnotations(Annotation[] annotations) {
            ...
            return new StatementContextFactoryRSP.AnnotationAnalysisResult(priority, preemptive);
        }
    }
}
