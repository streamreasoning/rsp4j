 ...
 * <p>
 * It is assumed that the timestamp passed to the apply method is ascending. The window is backed by a
...
public final class TimeWindow implements Iterable {
     ...
     */
    public final void remove(MapEventType theEvent) {
        if (reverseIndex == null) {
     ...
     */
    public final ArrayDeque<MapEventType> expireEvents(long expireBefore) {
        if (window.isEmpty()) {
            return null;
        }
        ...
        ArrayDeque<MapEventType> resultBeans = new ArrayDeque<MapEventType>();
        ...
        do {
            if (pair.getEventHolder() != null) {
                if (pair.getEventHolder() instanceof EventBean) {
                    resultBeans.add((MapEventType) pair.getEventHolder());
                } else {
                    resultBeans.addAll((List<MapEventType>) pair.getEventHolder());
                }
            }
        ...
        if (reverseIndex != null) {
            for (MapEventType expired : resultBeans) {
