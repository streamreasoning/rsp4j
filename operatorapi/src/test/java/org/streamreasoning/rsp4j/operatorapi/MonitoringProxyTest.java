...
import org.streamreasoning.rsp4j.operatorapi.monitoring.Metric;
import org.streamreasoning.rsp4j.operatorapi.monitoring.MonitoringR2RProxy;
import org.streamreasoning.rsp4j.operatorapi.monitoring.RSP4JMonitor;
...
public class MonitoringProxyTest {
    ...
    public void testMonitorTask(){
        ...
        TaskOperatorAPIImpl<Graph, Graph, Binding, Binding> t =
                new TaskOperatorAPIImpl.MonitoringTaskBuilder<Graph, Graph, Binding, Binding>()
