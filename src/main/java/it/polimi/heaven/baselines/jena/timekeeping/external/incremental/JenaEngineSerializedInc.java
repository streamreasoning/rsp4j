package it.polimi.heaven.baselines.jena.timekeeping.external.incremental;
...
import it.polimi.heaven.baselines.jena.events.jena.SerializedEvent;
 ...
 * **/
@Log4j
public class JenaEngineSerializedInc extends JenaEngine {

	public JenaEngineSerializedInc(String name, EventProcessor<Stimulus> collector, RSPListener listener) {
