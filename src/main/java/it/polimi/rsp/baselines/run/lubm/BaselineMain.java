...
import it.polimi.rsp.baselines.jena.StatementBaseline;
import it.polimi.rsp.baselines.jena.encoders.RDF2GraphStimulusEncoder;
import it.polimi.rsp.baselines.jena.encoders.RDF2StatementStimulusEncoder;
...
import it.polimi.rsp.baselines.utils.GetPropertyValues;
...
public class BaselineMain {
	...
	private static void init(String[] args) {
		...
		SQLListeService.openDatabase(dbPath, "lubm" + DT.format(EXPERIMENT_DATE).toString() + ".db");
	}
