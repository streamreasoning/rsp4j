...
public class BaselinesUtils {
	...
	public static final String JENA_INPUT_QUERY_NAIVE = " select  * from lubmEvent.win:time(" + omega + " msec) output snapshot every " + beta
			+ " msec";

	public static final String JENA_INPUT_QUERY_INCREMENTAL = " select irstream * from lubmEvent.win:time(" + omega + "msec) output all every "
			+ beta + " msec";
