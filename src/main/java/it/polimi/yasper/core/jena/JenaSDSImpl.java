...
public class JenaSDSImpl extends DatasetImpl implements Observer, JenaSDS {
    ...
    public JenaSDSImpl(Model tbox_star, Model knowledge_base_star, IRIResolver r, Maintenance maintenanceType, String id_base, EPServiceProvider esp, RSPQLEngine rsp) {
