...
public class JenaContinuousQueryExecutionBinding extends Observable implements Observer, ContinuousQueryExecution<Triple, BindingSet, Binding> {
    ...
    private List<StreamToRelationOperator<Triple, BindingSet>> s2rs;
    ...
    public JenaContinuousQueryExecutionBinding(IRIResolver resolver, WebDataStream out, ContinuousQuery query, SDS sds, RelationToRelationOperator<Binding> r2r, RelationToStreamOperator<Binding> r2s, StreamToRelationOperator<Triple, BindingSet>... s2rs) {
...
//        sds.materialize(now);
    ...
    public void addS2R(StreamToRelationOperator<Triple, BindingSet> op) {
        s2rs.add(op);
    }
