...
public class RETERuleInfTVGraph extends RETERuleInfGraph implements TimeVaryingInfGraph {
    ...
    public RETERuleInfTVGraph(Reasoner reasoner, Graph schema, long last_timestamp, TimeVaryingGraph w) {
    ...
    public RETERuleInfTVGraph(Reasoner reasoner, List<Rule> rules, Graph schema, long last_timestamp, TimeVaryingGraph w) {
