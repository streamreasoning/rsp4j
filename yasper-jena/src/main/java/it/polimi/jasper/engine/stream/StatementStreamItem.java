...
@NoArgsConstructor
public class StatementStreamItem extends StreamItem<Statement> {

    private static final long serialVersionUID = 1L;

    public StatementStreamItem(long appTimestamp1, Statement content1, String stream_uri) {
    ...
    public String toString() {
        return "StatementStreamItem {" + "appTimestamp='" + getAppTimestamp() + '\'' + ", sysTimestamp='" + getSysTimestamp()
