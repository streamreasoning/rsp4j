...
import it.polimi.jasper.reasoning.rulesys.BasicForwardRuleInfTVGraph;
import it.polimi.jasper.reasoning.rulesys.FBRuleInfTVGraph;
import it.polimi.jasper.sds.JenaTimeVaryingGraph;
import it.polimi.jasper.sds.WindowModel;
...
public class GenericRuleJenaTVGReasoner extends GenericRuleReasoner implements JenaTVGReasoner {
    ...
    public InfGraph bind(Graph data) throws ReasonerException {
        return bind((JenaTimeVaryingGraph) data);
    }
    ...
    public InfGraph bind(JenaTimeVaryingGraph data) throws ReasonerException {
