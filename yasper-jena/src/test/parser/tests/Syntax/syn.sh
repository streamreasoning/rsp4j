...
# Todo: geneate URIs, not bnodes, for test.parser.tests.
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.parser.tests/data-sparql11/syntax-query/manifest#>'
 )
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.parser.tests/data-sparql11/syntax-service/manifest#>'
)
...
(
    ...
    clean 
    source ../syn-arq.sh 
    createManifest "Syntax-test.parser.tests" '<manifest#>'
)
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.parser.tests/data-sparql11/syntax-update-1/manifest#>'
)
