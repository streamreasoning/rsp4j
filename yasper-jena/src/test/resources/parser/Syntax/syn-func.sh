...
# Functions in support of syntax test.java.parser.tests
# Source this file.
...
@prefix mf:     <http://www.w3.org/2001/sw/DataAccess/test.java.parser.tests/test-manifest#> .
@prefix mfx:    <http://jena.hpl.hp.com/2005/05/test-manifest-extra#> .
@prefix qt:     <http://www.w3.org/2001/sw/DataAccess/test.java.parser.tests/test-query#> .
@prefix dawgt:  <http://www.w3.org/2001/sw/DataAccess/test.java.parser.tests/test-dawg#> .

<>  rdf:type mf:Manifest ;
    rdfs:comment "Syntax test.java.parser.tests $LABEL" ;
    mf:entries
    ( 
EOF
...
# Build the manifest items.
    ...
    # test.java.parser.tests 1.1 Update
    for f in "${GOOD_ARQU[@]}"
    do
