...
# Todo: geneate URIs, not bnodes, for test.java.parser.tests.
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.java.parser.tests/data-sparql11/syntax-query/manifest#>'
 )
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.java.parser.tests/data-sparql11/syntax-service/manifest#>'
)

# test.java.parser.tests
(
    cd Syntax-ARQ
    clean 
    source ../syn-arq.sh 
    createManifest "Syntax-test.java.parser.tests" '<manifest#>'
)
...
(
	...
	'<http://www.w3.org/2009/sparql/docs/test.java.parser.tests/data-sparql11/syntax-update-1/manifest#>'
)
