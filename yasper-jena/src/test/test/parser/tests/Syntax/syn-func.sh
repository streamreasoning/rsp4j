...
# Functions in support of syntax test.parser.tests
# Source this file.
...
@prefix mf:     <http://www.w3.org/2001/sw/DataAccess/test.parser.tests/test-manifest#> .
@prefix mfx:    <http://jena.hpl.hp.com/2005/05/test-manifest-extra#> .
@prefix qt:     <http://www.w3.org/2001/sw/DataAccess/test.parser.tests/test-query#> .
@prefix dawgt:  <http://www.w3.org/2001/sw/DataAccess/test.parser.tests/test-dawg#> .

<>  rdf:type mf:Manifest ;
    rdfs:comment "Syntax test.parser.tests $LABEL" ;
    mf:entries
    ( 
EOF
