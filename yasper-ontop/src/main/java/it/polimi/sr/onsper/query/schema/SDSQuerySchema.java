...
//                }
        ...
        public <T> Relation<T> add(String schemaName, String tableName, DatabaseRelationDefinition table) {
...
/*        public <T> Collection<T> add(String name, Class<T> c) {
        ...
        public Schema build() {
            ...
            this.tempTableMap.entrySet().forEach(e -> builder.put(e.getKey(), e.getValue()));
