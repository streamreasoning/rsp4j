...
public class CQELSTimeWindowOperator implements StreamToRelationOperator<Graph, Graph> {
    ...
    private ContinuousQueryExecution context;

    public CQELSTimeWindowOperator(IRI iri, long a, long t0, Time time, Tick tick, Report report, ReportGrain grain, ContinuousQueryExecution context) {
        this.iri = iri;
        this.a = a;
        this.t0 = t0;
        this.time = time;
