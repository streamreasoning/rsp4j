...
//        cqe.outstream().addConsumer(new InstResponseSysOutFormatter("TTL", true));
    ...
    @Test
    public void cqelsBindings() throws ConfigurationException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
...
//        cqe.outstream().addConsumer(new InstResponseSysOutFormatter("TTL", true));
    ...
    public void csparql() throws ConfigurationException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        RSPQL<Binding> q = new SimpleRSPQLQuery<>("q1", stream, new WindowNodeImpl("w1", 2, 2, 0), s, pp, o);
