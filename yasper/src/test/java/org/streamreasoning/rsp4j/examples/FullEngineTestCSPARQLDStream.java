 ...
 */
public class FullEngineTestCSPARQLDStream {
...
//        cqe.outstream().addConsumer(new TestConsumer(results));
        ...
        stream.put(graph, 1500);

        //2001
        results.put(2001L, Collections.singleton(new BindingImpl()));

        BindingImpl binding2001 = new BindingImpl();
        binding2001.add(s, instance.createIRI("S2"));
        binding2001.add(o, instance.createIRI("O2"));
        ...
        binding3000.add(s, instance.createIRI("S3"));
